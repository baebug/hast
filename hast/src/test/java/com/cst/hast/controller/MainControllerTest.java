...
class MainControllerTest {
    ...
    List<UpdateArticleDto> updateArticleList = new ArrayList<>();
    ...
    void setUp() {
        ...
        // MockMembers
        updateArticleList.add(UpdateArticleDto.builder().headline("정원웅").url("www.com").build());
        updateArticleList.add(UpdateArticleDto.builder().headline("성정언").url("2222").build());
    }
    ...
    void getWorld() throws Exception {
        ...
        List<UpdateArticleDto> list = new ArrayList<>();
